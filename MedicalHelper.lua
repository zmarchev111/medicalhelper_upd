...
local buf_table_note = {
	...
	[21] = { name = u8("Лист 21"), text = u8("Пустой лист") },
	[22] = { name = u8("Лист 22"), text = u8("Пустой лист") },
	[23] = { name = u8("Лист 23"), text = u8("Пустой лист") },
	[24] = { name = u8("Лист 24"), text = u8("Пустой лист") },
	[25] = { name = u8("Лист 25"), text = u8("Пустой лист") },
	[26] = { name = u8("Лист 26"), text = u8("Пустой лист") },
	[27] = { name = u8("Лист 27"), text = u8("Пустой лист") },
	[28] = { name = u8("Лист 28"), text = u8("Пустой лист") },
	[29] = { name = u8("Лист 29"), text = u8("Пустой лист") },
	[30] = { name = u8("Лист 30"), text = u8("Пустой лист") },
	[31] = { name = u8("Лист 31"), text = u8("Пустой лист") },
	[32] = { name = u8("Лист 32"), text = u8("Пустой лист") },
	[33] = { name = u8("Лист 33"), text = u8("Пустой лист") },
	[34] = { name = u8("Лист 34"), text = u8("Пустой лист") },
	[35] = { name = u8("Лист 35"), text = u8("Пустой лист") },
	[36] = { name = u8("Лист 36"), text = u8("Пустой лист") },
	[37] = { name = u8("Лист 37"), text = u8("Пустой лист") },
	[38] = { name = u8("Лист 38"), text = u8("Пустой лист") },
	[39] = { name = u8("Лист 39"), text = u8("Пустой лист") },
	[40] = { name = u8("Лист 40"), text = u8("Пустой лист") },
	[41] = { name = u8("Лист 41"), text = u8("Пустой лист") },
	[42] = { name = u8("Лист 42"), text = u8("Пустой лист") },
	[43] = { name = u8("Лист 43"), text = u8("Пустой лист") },
	[44] = { name = u8("Лист 44"), text = u8("Пустой лист") },
	[45] = { name = u8("Лист 45"), text = u8("Пустой лист") },
	[46] = { name = u8("Лист 46"), text = u8("Пустой лист") },
	[47] = { name = u8("Лист 47"), text = u8("Пустой лист") },
	[48] = { name = u8("Лист 48"), text = u8("Пустой лист") },
	[49] = { name = u8("Лист 49"), text = u8("Пустой лист") },
	[50] = { name = u8("Лист 50"), text = u8("Пустой лист") },
}
...
function doklad()
	if calculateHospital() then
		...
		if calculatePost() then 
			if variable.partner ~= "" then
				if checkOnTag() then
					sampSendChat("/r [" ..u8:decode(buffer.buf_tag).. "] Пост: " ..calculatePost().. ". Напарник: " ..partner.. ". Осмотрено: " ..medWork.heal_post) 
				else
		...
		imgui.Spacing()
			imgui.BeginGroup()
				...
				if but.select_button[3] then
					CheckName()
					if imgui.Button(u8"Приветствие", imgui.ImVec2(142, 26)) then registerRolePlay(35) end -- приветствие
					if imgui.Button(u8"Попросить следовать", imgui.ImVec2(142, 26)) then registerRolePlay(36) end -- следовать
					if imgui.Button(u8"Попрощаться", imgui.ImVec2(142, 26)) then registerRolePlay(37) end -- прощание
				...
				lua_thread.create(function()
					for line in cmdtext:gmatch('[^\r\n]+') do
						...
						elseif line:match("{help:.+}") then
							sampAddChatMessage("[MedicalHelper] {ffffff}" ..u8:decode(line:match("{help:(.+)}")), CL.COLOR_RED)
						else
